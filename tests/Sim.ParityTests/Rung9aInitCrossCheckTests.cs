...
// vType defaults resolver init cross-check for rung 9a (junction straight-through). golden.
// vtype.json is keyed by vType id under "vTypes" with a single entry, "passenger0" -- run
// BEFORE the trajectory parity test, exactly like Rung8aInitCrossCheckTests (CLAUDE.md rule 6:
// match vType/init first when a parity gap appears).
public class Rung9aInitCrossCheckTests
{
