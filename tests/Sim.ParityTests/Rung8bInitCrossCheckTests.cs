...
// vType defaults resolver init cross-check for rung 8b (keep-right lane change).
// golden.vtype.json is keyed by vType id under "vTypes" with a single entry, "passenger0" --
// run BEFORE the trajectory parity test, exactly like Rung8aInitCrossCheckTests.
public class Rung8bInitCrossCheckTests
{
