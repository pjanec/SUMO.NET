...
// vType defaults resolver init cross-check for rung 5 (approach-and-stop, CLAUDE.md rule 6:
// match vType/init first when a parity gap appears). golden.vtype.json is keyed by vType id
// under "vTypes" with a single entry, "passenger0" -- run BEFORE the trajectory parity test
// below, exactly like Rung4InitCrossCheckTests.
public class Rung5InitCrossCheckTests
{
