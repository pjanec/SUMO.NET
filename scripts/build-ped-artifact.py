...
Runs the five Sim.Viz --ped-* scenes, base64-embeds each self-contained HTML into a single
...
SCENES = [
    ...
    ("dodge-reroute", "Dodge + reroute", "Local avoidance of a box, plus a mid-crossing blocker reroute"),
